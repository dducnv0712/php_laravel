<nav class="navbar fixed-top navbar-expand-lg navbar-light white scrolling-navbar">
    <div class="container">
        ...
        <a class="navbar-brand waves-effect" href="{{url('/')}}" target="_blank">
            <strong class="blue-text">LARAVEL TEST</strong>
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <!-- Right -->
            <?php $cart = session()->has("cartPr")?session()->get('cartPr'):[] ?>
            <ul class="navbar-nav nav-flex-icons">
                <li class="nav-item">
                    <a href="{{url('/cart')}}" class="nav-link waves-effect">
                        <i class="fas fa-shopping-cart"></i>
                        <span class="badge rounded-circle red z-depth-1 mr-1"> {{count($cart)}} </span>
